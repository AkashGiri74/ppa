...
int kth_ancestor(struct node*,struct node*,struct node*);
...
{    int pdata,key;
    ...
    printf("\n enter node you want to find kth kth_ancestor:");
    scanf("%d",&pdata);
    printf("\n enter key  I. e. which no of ansector:");
    scanf("%d",&key);
    kth_ancestor(root,createnode(pdata),createnode(key));
}
...
int kth_ancestor(struct node* root, struct node* p, struct node* k) 
{
